...
var getTopDoctorsHome = function getTopDoctorsHome(limit) {
...
var checkRequiredParams = function checkRequiredParams(inputData) {
  //, 'nameClinic'
  var arr = ['doctorId', 'contentHTML', 'contentMarkdown', 'action', 'selectedPrice', 'selectedPayment', 'selectedProvince', 'addressClinic', 'note', 'selectedSpecialty'];
  var isValid = true;
  var element = '';
...
var saveDoctorInfor = function saveDoctorInfor(inputData) {
  return new Promise( /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
      var checkParams, doctorMarkdown, doctorInfo;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            checkParams = checkRequiredParams(inputData);
...
var bulkCreateSchedule = function bulkCreateSchedule(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
      var schedule, finalResult, i, existedData, toCreate;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            if (!(!data.selectedTime && !data.doctorId && !data.date)) {
              _context5.next = 5;
              break;
            }
            resolve({
          ...
          case 10:
            existedData = _context5.sent;
            toCreate = _lodash["default"].differenceWith(finalResult, existedData, function (a, b) {
...
var getScheduleByIdAndDate = function getScheduleByIdAndDate(doctorId, date) {
  return new Promise( /*#__PURE__*/function () {
...
var sendRemedy = function sendRemedy(inputData) {
  return new Promise( /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 12:
            _context10.next = 14;
            return _EmailService["default"].sendAttachment(inputData);
          case 14:
            resolve({
              errCode: 0,
