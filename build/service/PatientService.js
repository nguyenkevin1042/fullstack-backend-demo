...
var buildUrlEmail = function buildUrlEmail(doctorId, token) {
  var result = process.env.URL_REACT + "/verify-booking?token=" + token + "&doctorId=" + doctorId;
  return result;
};
var saveNewPatientBookingSchedule = function saveNewPatientBookingSchedule(data) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            break;
          case 5:
            token = (0, _uuid.v4)(); //upsert patient
            _context.next = 8;
