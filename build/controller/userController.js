    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _UserService["default"].createNewUser(request.body);
        case 3:
          message = _context3.sent;
          return _context3.abrupt("return", response.status(200).json(message));
        case 7:
          _context3.prev = 7;
  ...
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(request, response) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 8:
          _context4.next = 10;
          return _UserService["default"].deleteUser(idParam).message;
        case 10:
          result.message = _context4.sent;
        case 11:
          return _context4.abrupt("return", response.status(200).json(result));
        case 14:
          _context4.prev = 14;
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 4;
          return _UserService["default"].editUser(request.body);
        case 4:
          result.message = _context5.sent;
          return _context5.abrupt("return", response.status(200).json(result));
        case 8:
          _context5.prev = 8;
...
var handleGetAllCodes = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(request, response) {
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
          ...
          setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
            ...
            return _regeneratorRuntime().wrap(function _callee6$(_context6) {
              while (1) switch (_context6.prev = _context6.next) {
                case 0:
                  _context6.next = 2;
                  return _UserService["default"].getAllCodes(request.query.type);
                case 2:
                  data = _context6.sent;
                  return _context6.abrupt("return", response.status(200).json(data));
                case 4:
                case "end":
        ...
        case 4:
          ...
          console.log('All errors: ', _context7.t0);
  ...
  return function handleGetAllCodes(_x11, _x12) {
