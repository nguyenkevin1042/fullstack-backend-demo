...
let initWebRoutes = (app) => {
    ...
    router.get("/api/get-list-patient",
        doctorController.handleGetListPatient);
    ...
    router.post("/api/create-new-clinic",
        clinicController.handleSaveNewClinic);
    router.get("/api/get-all-clinic",
